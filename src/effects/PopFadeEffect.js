(function (spiderOakApp, window, undefined) {
  ...
  var Backbone    = window.Backbone,
    ...
    spiderOakApp.PopFadeEffect = window.BackStack.Effect.extend({

        fromViewTransitionProps:{duration:0.2, easing:'ease-in-out', delay:0.1},

        toViewTransitionProps:{duration:0.2, easing:'ease-in-out', delay:0.1},
